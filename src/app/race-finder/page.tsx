...
export const metadata: Metadata = {
  title: "Race Finder",
  description: "Live forming Gigling lobbies, ranked by your win edge. Paddock has a calibrated odds model, so it does not just show you open races, it tells you which one to enter and with which horse. Read-only, no login required.",
};
    ...
    <div className="mx-auto max-w-page px-4 py-8 md:px-6 md:py-12">
      <header className="mb-6 max-w-2xl">
        ...
        <p className="type-body mt-3 text-ink-soft">
          Open races, ranked by YOUR win edge. Most boards just show you forming lobbies and a join button. Paddock has a calibrated odds model, so it tells you which lobby to enter and with which horse. Add your wallet address to see your win probability in each field; the data is read-only, no signature, no connection.
        </p>
      </header>
