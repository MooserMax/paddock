...
const ENDPOINTS = [
  ...
  { method: "GET", path: "/lobbies", title: "Race Finder, live lobbies", desc: "Open forming races right now, read-only and live (polled politely, cached a few seconds, so it may lag). Each lobby carries trackLength, raceTemp (null while forming), fieldSize, petCount, openSlots, entryFeeWei, payoutBps, and the current entrants with strength. Add ?wallet={address} or ?pet={id} and each lobby also carries your win probability (from the calibrated odds model), EV, and recommended horse. Forming-field odds shift as horses enter and are calibrated estimates, never guarantees." },
